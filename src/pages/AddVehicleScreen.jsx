...
export default function AddVehicleScreen() {
  ...
  const next = () => {
    ...
    const scrollArea = document.getElementById('step-scroll-area')
  ...
  return (
    <div className="fixed inset-0 bg-dark-bg flex flex-col max-w-md mx-auto">
      ...
      {/* ───── SCROLLABLE STEP CONTENT (fills middle) ───── */}
      <div id="step-scroll-area" className="flex-1 overflow-y-auto min-h-0">
      ...
      {/* ───── BOTTOM BUTTONS (pinned at bottom, always visible) ───── */}
        ...
        <div className="flex gap-3">
          {step > 1 && (
            <button
              type="button"
              onClick={back}
              className="flex-1 py-3.5 bg-dark-card border border-dark-border rounded-2xl text-sm font-semibold text-primary active:scale-[0.98] transition-transform"
            >
              Back
            </button>
          )}
          {step === 5 && (
            <button
              type="button"
              onClick={next}
              className="py-3.5 px-5 bg-dark-card border border-dark-border rounded-2xl text-sm font-semibold text-muted active:scale-[0.98] transition-transform"
            >
              Skip
            </button>
          )}
          {step < 6 ? (
            <button
              type="button"
              onClick={next}
              className="flex-1 flex items-center justify-center gap-1 py-3.5 bg-accent text-white rounded-2xl text-sm font-semibold shadow-md shadow-accent/25 active:scale-[0.98] transition-transform"
            >
            ...
            <button
              ...
              onClick={handleSave}
              disabled={saving}
              className="flex-1 flex items-center justify-center gap-2 py-3.5 bg-accent text-white rounded-2xl text-sm font-semibold shadow-md shadow-accent/25 active:scale-[0.98] transition-transform disabled:opacity-50"
            >
